    ...
    switch (cardId) {
        ...
        case 'diveStrafe': {
            ...
            setTimeout(() => {
                ...
                playSound('airstrike');
                // 600ms 后启动机枪弹幕（与 machinegun 音效同步），弹流来源跟随飞机位置
                setTimeout(() => {
                    ...
                    for (let i = 0; i < 4; i++) {
                        ...
                        setTimeout(() => {
                            spawnDroneProjectile(planeX, planeY, tx, ty, result.isCrit);
                            spawnDroneProjectile(planeX + 30, planeY + 20, tx, ty, result.isCrit);
                        }, i * 110);
                    }
                }, 600);
                setTimeout(() => {
