...
export default {
    ...
    skills: [
        { name: '制空', desc: '无法使用普通对策卡。上校存活且部署时可消耗金币使用专属空军对策卡，每使用1张空军卡使本场空军伤害提高10%，最多叠加4层，最大航程为6格，雾天停飞无法使用', type: 'passive' },
        { name: '扫射', desc: '$3 对指定单体目标造成伤害，目标生命值低于50%时额外无视其25%防御力', type: 'active' },
