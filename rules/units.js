...
export const UNIT_CONFIG = deepFreeze({
    ...
    // 基础舰船：面板保持在现有兵种量级内，不预设额外克制关系。
    warship: { name: '舰', hp: 180, attack: 45, defense: 0.08, speed: 5, range: 2, cost: 14, color: '#315f78', movementDomain: 'naval' }
});

/** 行为克制关系。1 为无修正，大于 1 为顺克，小于 1 为逆克。 */
export const COUNTER_RELATION = deepFreeze({
    infantry: { archer: 0.75, cavalry: 1.25, infantry: 1, mgNest: 0.75, drone: 1, warship: 1 },
    archer: { cavalry: 0.75, infantry: 1.25, archer: 1, mgNest: 1.25, drone: 1, warship: 1 },
    cavalry: { infantry: 0.75, archer: 1.25, cavalry: 1, mgNest: 0.75, drone: 1, warship: 1 },
    mgNest: { infantry: 1.25, archer: 0.75, cavalry: 1.25, mgNest: 1, drone: 1, warship: 1 },
    drone: { infantry: 1.25, archer: 1, cavalry: 1, mgNest: 1, drone: 1, warship: 1 },
    warship: { infantry: 1, archer: 1, cavalry: 1, mgNest: 1, drone: 1, warship: 1 }
});
